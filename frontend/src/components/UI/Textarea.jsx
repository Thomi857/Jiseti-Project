...
const Textarea = ({
  ...
  const textareaClasses = `block w-full rounded-lg border border-jisefi-light-grey shadow-sm px-4 py-2.5 text-base text-jisefi-dark-grey focus:outline-none focus:border-jisefi-green-light focus:ring-2 focus:ring-jisefi-green-light/20 transition-all duration-200 ${
