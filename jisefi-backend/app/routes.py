...
# Get all reports (admin) or own (user)
...
def get_reports():
    ...
    reports = Report.query.all() if user_role == 'admin' else Report.query.filter_by(user_id=user_id).all()
...
def update_report_status(report_id):
    ...
    valid_statuses = [
        ReportStatus.under_investigation.value,
